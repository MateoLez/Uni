                    ...
                    <div class="col-md-12">
                        <div class="card-body wizard-content">
                            <form class="form-horizontal" method="POST"  action="{{ route('registro.store') }}" encrypte="multipart/form-data" id="a">
                                @csrf
                                <div class="card-body">
                                    <h4 style="text-align: center;" class="card-title">Información Principal</h4>
                                    <br>
                                    <br>
...
<br>
                                    <h4 style="text-align: center;">Información complementaria</h4>
                                    <br>
                                    <br>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-end control-label col-form-label">Nombre del papá</label>
                                        <div class="col-sm-6">
                                            <input type="text" required="" style="text-align: center;" class="form-control" id="fname" placeholder="Nombre del papá" name="Papa">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-end control-label col-form-label">Nombre de la mamá</label>
                                        <div class="col-sm-6">
                                            <input type="text" required="" style="text-align: center;" class="form-control" id="lname" placeholder="Nombre de la mamá" name="Mama">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-end control-label col-form-label">Dirección de residencia</label>
                                        <div class="col-sm-6">
                                            <input type="text" required="" style="text-align: center;" class="form-control" id="lname" placeholder="Dirección de residencia" name="Direccion">
                                        </div>
                                    </div>
                                    <div class="form-group row">
